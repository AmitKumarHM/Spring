...
public class IncomingBagInsertMapperImpl<K, V, D> extends BaseMapperImpl<K, V, D> implements IncomingBagInsertMapper<K, V, D> {
	...
	public void incomingBagInsertMapper(HashMap<K, V> insertDispatchMap, ArrayList<HashMap<K, V>> arrayList) {
		...
		V bagSealNumber=delhiveryCollection.getValue((K)DelhiveryBagKeyAndColumn.BAG_SEAL_NUMBER, insertDispatchMap);
		...
		while(successItr.hasNext()){
			 ...
			 successMap.put((K)DelhiveryEtlKeys.DB_BAG_SEAL_NUMBER,bagSealNumber);
			 ...
			 successMap.put((K)DelhiveryEtlKeys.DB_INCOMING_DATE,(V)(!DelhiveryUtils.isNULL(incomingDate)?incomingDate.toString().substring(DelhiveryEtlConstants.FIRST_INDEX, DelhiveryEtlConstants.TEN_INDEX):null));
		...
		while(failedItr.hasNext()){
			 ...
			 failedMap.put((K)DelhiveryEtlKeys.DB_BAG_SEAL_NUMBER,bagSealNumber);
			 ...
			 failedMap.put((K)DelhiveryEtlKeys.DB_INCOMING_DATE,(V)(!DelhiveryUtils.isNULL(incomingDate)?incomingDate.toString().substring(DelhiveryEtlConstants.FIRST_INDEX, DelhiveryEtlConstants.TEN_INDEX):null));
		...
		while(unexpectedItr.hasNext()){
			 ...
			 unexpectedMap.put((K)DelhiveryEtlKeys.DB_BAG_SEAL_NUMBER,bagSealNumber);
			 ...
			 unexpectedMap.put((K)DelhiveryEtlKeys.DB_INCOMING_DATE,(V)(!DelhiveryUtils.isNULL(incomingDate)?incomingDate.toString().substring(DelhiveryEtlConstants.FIRST_INDEX, DelhiveryEtlConstants.TEN_INDEX):null));
		...
		while(bagsItr.hasNext()){
			 ...
			 successBagMap.put((K)DelhiveryEtlKeys.DB_BAG_SEAL_NUMBER,bagSealNumber);
			 ...
			 successBagMap.put((K)DelhiveryEtlKeys.DB_INCOMING_DATE,(V)(!DelhiveryUtils.isNULL(incomingDate)?incomingDate.toString().substring(DelhiveryEtlConstants.FIRST_INDEX, DelhiveryEtlConstants.TEN_INDEX):null));
		...
		while(failedbagsItr.hasNext()){
			 ...
			 failedBagMap.put((K)DelhiveryEtlKeys.DB_BAG_SEAL_NUMBER,bagSealNumber);
			 ...
			 failedBagMap.put((K)DelhiveryEtlKeys.DB_INCOMING_DATE,(V)(!DelhiveryUtils.isNULL(incomingDate)?incomingDate.toString().substring(DelhiveryEtlConstants.FIRST_INDEX, DelhiveryEtlConstants.TEN_INDEX):null));
		...
		while(unexpectedbagsItr.hasNext()){
			 ...
			 unexpectedBagMap.put((K)DelhiveryEtlKeys.DB_BAG_SEAL_NUMBER,bagSealNumber);
			 ...
			 unexpectedBagMap.put((K)DelhiveryEtlKeys.DB_INCOMING_DATE,(V)(!DelhiveryUtils.isNULL(incomingDate)?incomingDate.toString().substring(DelhiveryEtlConstants.FIRST_INDEX, DelhiveryEtlConstants.TEN_INDEX):null));
	...
	public void incomingBagInsertStringMapper(HashMap<K, V> insertDispatchMap, StringBuilder insertString) {
		...
		while(successItr.hasNext()){
			 ...
			 insertString.append(!DelhiveryUtils.isNULL(incomingDate)?incomingDate.toString().substring(DelhiveryEtlConstants.FIRST_INDEX, DelhiveryEtlConstants.TEN_INDEX)+DelhiveryEtlConstants.PIPE:DelhiveryEtlConstants.PIPE);
